...
public class Debug {
    ...
    public static void logCharacterMessage(String message, Character character, boolean isPublic) {
        if (isPublic) {
            ...
            message = String.format("\u00A71\u00A7l\u00A7o<%s>\u00A7r %s", message);
    ...
    public static void logWarning(String message) {
        ...
        // AltoClef altoClef = AltoClef.getInstance();
        // if (altoClef != null &&
        // !altoClef.getModSettings().shouldHideAllWarningLogs()) {
        // if (MinecraftClient.getInstance() != null &&
        // MinecraftClient.getInstance().player != null) {
        // String msg = "\u00A72\u00A7l\u00A7o" + getLogPrefix() + "\u00A7c" + message +
        // "\u00A7r";
    ...
    private static boolean canLog(int level) {
        if (AltoClef.getInstance() == null || AltoClef.getInstance().getModSettings() == null)
            return true;
